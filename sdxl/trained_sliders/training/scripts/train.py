...
#
# Self-contained copy of trainscripts/textsliders/train_lora_xl.py.
# Utility modules (lora, prompt_util, ...) are imported from core/sdxl/ —
# the single shared SDXL library used across the repo.
